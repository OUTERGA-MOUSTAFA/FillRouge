...
class MatchingService
{
    ...
    /**
     * ✅ Méthode getRecommendations - corrigée
     */
    public function getRecommendations(User $user, $limit = 10)
    {
        // Récupérer les utilisateurs potentiels (exclure soi-même)
        ...
        foreach ($potentialMatches as $match) {
            ...
            if (!$existingMatch || $existingMatch->status !== 'blocked') {
                ...
                if ($score >= 40) { // Seuil minimum de compatibilité
                    $recommendations[] = [
                        'user' => [
                            'id' => $match->id,
    ...
    /**
     * Méthode getCommonInterests - publique
     */
