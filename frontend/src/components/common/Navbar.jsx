...
import {
  Bars3Icon, XMarkIcon, UserCircleIcon, PhotoIcon,
            ...
            <Menu.Item key={lang.code}>
              {({ active }) => (
                <button
                  ...
                  className={`flex items-center gap-2 w-full px-3 py-2 text-sm text-gray-700 transition-colors ${active ? 'bg-gray-50' : ''
                ...
                <div className="hidden md:flex items-center gap-0.5">
                  {navItems.map(item => (
                    <Link
                      key={item.name}
                      to={item.href}
                      className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${isActive(item.href)
                ...
                {user ? (
                  <>
                    ...
                    {[
                      ...
                      { href: '/my-listings', label: 'Mes annonces' },
